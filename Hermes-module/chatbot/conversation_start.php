 ...
 *
 * To access this file via API you need to call with these variables:
 * $say                 -> The input of our user 
 * $convo_id            -> The id of the conversation
 * $bot_id              -> The id of the bot to use
 * $form_vars['format'] -> The format of the result you expect
